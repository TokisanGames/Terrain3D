...
public partial class Terrain3D : Node3D
{
    ...
    {
        get => Get(GDExtensionPropertyName.Material).As<Terrain3DMaterial>();
        set => Set(GDExtensionPropertyName.Material, value);
    }

    public new Terrain3DAssets Assets
    {
        get => Get(GDExtensionPropertyName.Assets).As<Terrain3DAssets>();
    ...
    public new Variant CollisionTarget
    {
        get => Get(GDExtensionPropertyName.CollisionTarget).As<Variant>();
    ...
    public new Variant ClipmapTarget
    {
        get => Get(GDExtensionPropertyName.ClipmapTarget).As<Variant>();
    ...
    public new Terrain3DEditor GetEditor() => 
        Call(GDExtensionMethodName.GetEditor, []).As<Terrain3DEditor>();

    public new void SetPlugin(EditorPlugin plugin) => 
        Call(GDExtensionMethodName.SetPlugin, [plugin]);

    public new EditorPlugin GetPlugin() => 
        Call(GDExtensionMethodName.GetPlugin, []).As<EditorPlugin>();
