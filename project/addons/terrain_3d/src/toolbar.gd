...
func _ready() -> void:
	...
	add_tool_button(Terrain3DEditor.AUTOSHADER, Terrain3DEditor.ADD, "Autoshader", load(ICON_AUTOSHADER), tool_group)
	add_child(HSeparator.new())
	add_tool_button(Terrain3DEditor.COLOR, Terrain3DEditor.ADD, "Paint Color", load(ICON_COLOR), tool_group)
	add_tool_button(Terrain3DEditor.ROUGHNESS, Terrain3DEditor.ADD, "Paint Wetness", load(ICON_WETNESS), tool_group)
	add_child(HSeparator.new())
	add_tool_button(Terrain3DEditor.HOLES, Terrain3DEditor.ADD, "Create Holes", load(ICON_HOLES), tool_group)
	add_tool_button(Terrain3DEditor.NAVIGATION, Terrain3DEditor.ADD, "Paint Navigable Area", load(ICON_NAVIGATION), tool_group)
