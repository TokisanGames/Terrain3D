...
const DirectoryWizard: Script = preload("res://addons/pasture_3d/menu/directory_setup.gd")
const ChannelPacker: Script = preload("res://addons/pasture_3d/menu/channel_packer.gd")
const LodBaker: Script = preload("res://addons/pasture_3d/menu/baker.gd")
...
func _on_menu_about_to_popup() -> void:
	...
	if plugin.terrain:
		...
		var terrains: Array[Pasture3D] = baker.find_nav_region_terrains(plugin.nav_region)
