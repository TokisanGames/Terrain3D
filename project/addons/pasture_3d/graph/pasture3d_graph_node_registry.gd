...
static func entries() -> Array[Dictionary]:
	return [
		...
		{"op": &"scree", "title": "Scree", "role": "Solver", "script": Pasture3DGraphNodeScree, "tags": ["talus", "rubble", "rock", "slope", "erosion", "deposition"], "description": "Sheds loose rock off steep ground; outputs height + a shed mask."},
			{"op": &"erosion", "title": "Erosion", "role": "Solver", "script": Pasture3DGraphNodeErosion, "tags": ["river", "fluvial", "stream", "hydraulic", "water", "valley", "channel", "sediment"], "description": "Stream-power fluvial erosion; outputs eroded height + flow / erosion / deposition / wetness channels."},
			{"op": &"dla", "title": "DLA", "role": "Solver", "script": Pasture3DGraphNodeDLA, "tags": ["mountain", "ridge", "massif", "aggregation", "diffusion", "branch", "peak", "range"], "description": "Diffusion-limited-aggregation mountain; grows a branching ridge massif, outputs height + a footprint mask."},
