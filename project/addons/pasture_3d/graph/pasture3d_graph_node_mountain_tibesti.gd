@tool
class_name Pasture3DGraphNodeMountainTibesti
extends Pasture3DGraphNode

## Massive volcanic alpine massif / high-altitude plateau with Gabor wave ridgelines, ported from Hesiod/HighMap.
...
func op() -> StringName:
	return &"mountain_tibesti"


func display_name() -> String:
	return "Mountain Tibesti"
...
func eval_grid_channels(p_inputs: Array, p_gw: int, p_gh: int, _p_mask, p_rect: Rect2) -> Array:
	...
	if not ClassDB.class_has_method("Pasture3DUtil", "mountain_tibesti_generate_grid"):
