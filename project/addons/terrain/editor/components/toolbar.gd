...
const ICON_HEIGHT_DIV: Texture2D = preload("res://addons/terrain/icons/icon_height_div.svg")
const ICON_HEIGHT_FLAT: Texture2D = preload("res://addons/terrain/icons/icon_height_flat.svg")
const ICON_HEIGHT_SMOOTH: Texture2D = preload("res://addons/terrain/icons/icon_height_smooth.svg")
