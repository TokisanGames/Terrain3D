...
public:
	...
	Dictionary get_raycast_result(const Vector3 &p_src_pos, const Vector3 &p_destination, const uint32_t p_col_mask = 4294967295u, const bool p_exclude_self = true) const;
