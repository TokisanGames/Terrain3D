...
void Terrain3D::set_vertex_spacing(const real_t p_spacing) {
	real_t spacing = round(CLAMP(p_spacing, 0.25f, 100.0f) * 16.f) / 16.f;
...
void Terrain3D::_bind_methods() {
	...
	ADD_PROPERTY(PropertyInfo(Variant::FLOAT, "vertex_spacing", PROPERTY_HINT_RANGE, "0.25,10.0,0.0625,or_greater"), "set_vertex_spacing", "get_vertex_spacing");
