...
void Terrain3D::_bind_methods() {
	...
	ClassDB::bind_method(D_METHOD("get_compression_mode"), &Terrain3D::get_compression_mode);
	ClassDB::bind_method(D_METHOD("set_compression_mode", "compression_mode"), &Terrain3D::set_compression_mode);
	...
	ADD_PROPERTY(PropertyInfo(Variant::INT, "compression_mode", PROPERTY_HINT_ENUM, "COMPRESS_S3TC,COMPRESS_ETC,COMPRESS_ETC2,COMPRESS_BPTC,COMPRESS_ASTC,COMPRESS_MAX"), "set_compression_mode", "get_compression_mode");
