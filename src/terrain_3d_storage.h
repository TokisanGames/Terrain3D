...
public:
	...
	Vector2i get_region_locationp(const Vector3 &p_global_position) const;
...
inline Vector2i Terrain3DStorage::get_region_locationp(const Vector3 &p_global_position) const {
...
inline int Terrain3DStorage::get_region_idp(const Vector3 &p_global_position) const {
	return get_region_id(get_region_locationp(p_global_position));
}
