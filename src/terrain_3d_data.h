...
public:
	...
	void save_region(const Vector2i &p_region_loc, const String &p_dir, const bool p_16_bit = false, const Image::CompressMode p_compression_mode = Image::COMPRESS_MAX);
