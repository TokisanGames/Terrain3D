...
#ifndef PASTURE3D_MATERIAL_CLASS_H
#define PASTURE3D_MATERIAL_CLASS_H
...
class Pasture3DMaterial : public Resource {
	GDCLASS(Pasture3DMaterial, Resource);
	CLASS_NAME();
...
#endif // PASTURE3D_MATERIAL_CLASS_H