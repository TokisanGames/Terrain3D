...
#include "logger.h"
#include "ocean_clipmap.h"

///////////////////////////
// Private Functions
///////////////////////////

RID OceanClipMap::_create_mesh(PackedVector3Array p_vertices, PackedInt32Array p_indices, AABB p_aabb) {
	Array arrays;
 ...
 */
Vector<RID> OceanClipMap::generate(int p_size, int p_levels) {
