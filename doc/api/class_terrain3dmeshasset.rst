...
Returns the color of the current highlight material, if any. For editor use.
...
Returns true if this mesh asset is currently highlighted. For editor use.
...
Toggles the highlight for this mesh asset. For editor use.
