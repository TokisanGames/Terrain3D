...
.. table::
   ...
   +----------------+----------------------------------------------------------------------------------+--------------------------------------+
   | ``bool``       | :ref:`deleted<class_Terrain3DRegion_property_deleted>`                           | ``false``                            |
   +----------------+----------------------------------------------------------------------------------+--------------------------------------+
   | ``bool``       | :ref:`edited<class_Terrain3DRegion_property_edited>`                             | ``false``                            |
   +----------------+----------------------------------------------------------------------------------+--------------------------------------+
   ...
   +----------------+----------------------------------------------------------------------------------+--------------------------------------+
   | ``Vector2i``   | :ref:`location<class_Terrain3DRegion_property_location>`                         | ``Vector2i(2147483647, 2147483647)`` |
   +----------------+----------------------------------------------------------------------------------+--------------------------------------+
   | ``bool``       | :ref:`modified<class_Terrain3DRegion_property_modified>`                         | ``false``                            |
   +----------------+----------------------------------------------------------------------------------+--------------------------------------+
...
This map stores wetness that modifies texture roughness and color that is multipled into the terrain textures.

\ ``get_color_map()`` returns the uncompressed map, only.

In game, this map will be cleared if :ref:`Terrain3D.color_compress_mode<class_Terrain3D_property_color_compress_mode>` is set and :ref:`Terrain3D.keep_uncompressed_color<class_Terrain3D_property_keep_uncompressed_color>` is not.
...
In game, this map will be used by the renderer if available. The compressed color map cannot be read or written to per pixel, so if you want to edit or read it at runtime, disable color compression or use :ref:`Terrain3D.keep_uncompressed_color<class_Terrain3D_property_keep_uncompressed_color>`.
...
``bool`` **deleted** = ``false`` :ref:`🔗<class_Terrain3DRegion_property_deleted>`
...
``bool`` **edited** = ``false`` :ref:`🔗<class_Terrain3DRegion_property_edited>`
...
``Vector2i`` **location** = ``Vector2i(2147483647, 2147483647)`` :ref:`🔗<class_Terrain3DRegion_property_location>`
...
``bool`` **modified** = ``false`` :ref:`🔗<class_Terrain3DRegion_property_modified>`
...
Compresses the color map with the specified compression mode. Compression only works in the editor, not at runtime.
